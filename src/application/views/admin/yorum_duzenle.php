...
<input type="hidden" name="itiraf_id" value="<?php echo $yorumlar->itiraf_id; ?>">
<input type="hidden" name="id" value="<?php echo $yorumlar->id; ?>">
<div class="form-group">
<label for="yorum_rumuz">Rumuz</label>
<input type="text" class="form-control" id="yorum_rumuz" name="yorum_rumuz" value="<?php echo $yorumlar->yorum_rumuz; ?>">
</div>
<div class="form-group">
