...
<li class="breadcrumb-item active">İtiraf Düzenle</li>
</ol>
<div class="card mb-3">
<div class="card-header">
<i class="fa fa-sticky-note"></i> İtiraf Düzenle</div>
<div class="card-body">
<form action="<?php echo base_url("admin/itiraflar/duzenle/update/$itiraflar->id"); ?>" method="post">
<div class="form-group">
<label for="itiraf_rumuz">Rumuz</label>
<input type="text" class="form-control" id="itiraf_rumuz" name="itiraf_rumuz" value="<?php echo $itiraflar->itiraf_rumuz; ?>">
</div>
<div class="form-group">
<label for="itiraf_icerik">İtiraf İçeriği</label>
<textarea rows="5" class="form-control" id="itiraf_icerik" name="itiraf_icerik"><?php echo html_escape($itiraflar->itiraf_icerik); ?></textarea>
</div>
<div class="form-group">
<label for="itiraf_durum">Onaylı mı?</label>
<select class="form-control" id="itiraf_durum" name="itiraf_durum">
<option value="1" <?php if($itiraflar->itiraf_durum=="1"){echo "selected";}; ?>>Onaylı</option>
<option value="0" <?php if($itiraflar->itiraf_durum=="0"){echo "selected";}; ?>>Onaysız</option>
</select>
</div>
<input type="hidden" name="id" value="<?php echo $itiraflar->id; ?>">
<div class="form-group">
